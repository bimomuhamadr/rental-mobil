  ...
  <body>
    <?php 
      if (isset($_SESSION['tglawal']) AND isset($_SESSION['tglakhir'])) {    
        $hasil = mysql_query("SELECT * FROM t_transaksi WHERE DATE(tgl_sewa) BETWEEN '$_SESSION[tglawal]' AND '$_SESSION[tglakhir]';"); 
      ...
      <?php
        ...
        $no++;                 
          ...
          echo "<tr align=center>";
            ...
            $sqlll = mysql_query("SELECT * FROM t_mobil where id_mobil = '$data[id_mobil]'");
