...
?>
    ...
    <?php if ($_GET['ubah']=="user") { ?>
        <?php
            if(isset($_GET['id_user'])){
                ...
                $sql = mysql_query("SELECT * FROM `t_user` WHERE id_user='$id_user'");
    ...
    <?php if ($_GET['ubah']=="mobil") { ?>
        <?php
            if(isset($_GET['id_mobil'])){
                ...
                $sql = mysql_query("SELECT * FROM `t_mobil` WHERE id_mobil='$id_mobil'");
                while ($_POST = mysql_fetch_array($sql)) {
    ...
    <?php if ($_GET['detail']=="detailtransaksi") { ?>
        <?php
            if(isset($_GET['id_transaksi'])){
                $id_transaksi = $_GET['id_transaksi'];
                $sql = mysql_query("SELECT * FROM `t_transaksi` WHERE id_transaksi='$id_transaksi'");
                while ($_POST = mysql_fetch_array($sql)) {                    
                    ...
                    $sqlll = mysql_query("SELECT * FROM t_mobil where id_mobil = '$_POST[id_mobil]'");
                    $data1 = mysql_fetch_assoc($sqlll);
    ...
    <?php if ($_GET['detail']=="detailkonfirmasi") { ?>
        <?php
            if(isset($_GET['id_konfirmasi'])){
                ...
                mysql_query("UPDATE `t_konfirmasi` SET `ket`='$ket' WHERE `id_konfirmasi`='$id_konfirmasi'");
            }
        ?> 
