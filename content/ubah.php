...
if($_GET['ubah']=="user") {
	...
	if(isset($_POST['ubah-user'])){
            ...
            $alamat = $_POST['alamat'];
			$akses = $_POST['akses'];			
		mysql_query("UPDATE `t_user` SET nik_ktp='$nik_ktp', no_sim='$no_sim', nama_user='$nama_user', email_user='$email_user', no_hp='$no_hp', alamat='$alamat', akses='$akses' WHERE id_user='$id_user'");
...
if($_GET['ubah']=="datauser") {
    ...
    if(isset($_POST['ubah-datauser'])){
            ...
            $no_hp = $_POST['no_hp'];
            $alamat = $_POST['alamat'];     
        mysql_query("UPDATE `t_user` SET nik_ktp='$nik_ktp', no_sim='$no_sim', nama_user='$nama_user', email_user='$email_user', no_hp='$no_hp', alamat='$alamat' WHERE id_user='$id_user'");
...
if($_GET['ubah']=="passuser") {
    ...
    if(isset($_POST['ubah-passuser'])){
        ...
        mysql_query("UPDATE `t_user` SET password=MD5('$password') WHERE id_user='$id_user'");
...
if($_GET['ubah']=="transaksimobil") {
    ...
    if(isset($_POST['ubah-transaksimobil'])){
        ...
        if ($_POST['status_sewa'] == '2') {
            mysql_query("UPDATE `t_transaksi` SET status_sewa='$status_sewa', ket='$ket' WHERE id_transaksi='$id_transaksi'");
