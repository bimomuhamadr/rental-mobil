            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <?php
                        $tot = 0;
                        $hasil = mysql_query("SELECT * FROM `t_transaksi` WHERE id_user = '$_SESSION[iduser]' ORDER BY tgl_sewa DESC");
                        ?>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" style="font-size: 13px;">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            echo "<tr>";
                                                echo "<td>" . $no . "</td>";
                                                $sqll = mysql_query("SELECT * FROM t_mobil where id_mobil = '$data[id_mobil]'");
